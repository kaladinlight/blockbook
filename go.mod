...
require (
	github.com/ava-labs/coreth v0.7.2
	github.com/ethereum-optimism/optimism/l2geth v0.0.0-20230104192053-f7973b3a5934
)
...
require (
	...
	github.com/ava-labs/avalanchego v1.7.15-rc.10 // indirect
